...
import { Logo } from '../../AllFilesAccess'
  ...
  return (
    <>
      <header className='shadow-lg flex justify-between items-center py-2 px-6 sm:px-9 md:px-16 z-100 sticky top-0 bg-white'>
        ...
        <nav className={`shadow-lg md:shadow-none flex flex-col items-end text-end md:flex md:items-end absolute top-14 md:static w-full md:w-fit py-5 px-10 md:p-0 gap-5 md:gap-1.5 transition-all duration-200 ease-in-out z-5 ${ToggleNav ? "right-0" : "right-[800px]"} md:pb-0 pb-12 md:bg-transparent bg-white z-0`}>
          <div className='SocialMedia flex gap-5 text-3xl md:text-xl order-2 md:order-1'>
            {
